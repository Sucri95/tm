        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">Carga de contenido principal</div>
                    ...
                    <div class="panel-body">
                        <ul>
                            ...
                            <li><a class="home-a" href="<?php echo e(url('/home/cases')); ?>">Cargar casos</a></li>
                            <li><a class="home-a" href="<?php echo e(url('/home/portfolios')); ?>">Cargar portfolio</a></li>
                            <li><a class="home-a testimonials" href="<?php echo e(url('/home/testimonials')); ?>">Cargar testimonios</a></li>
                            <!--
                            <li><a class="home-a clientslogos" href="<?php echo e(url('/home/clients')); ?>">Cargar logo de los clientes</a></li>
                            -->
                        </ul>
                    </div>
                ...
                <div class="panel-heading" style="border-top: 1px solid #d3e0e9;">Carga de información sobre la empresa</div>
                    ...
                    <div class="panel-body">
                        <ul>
                            <li><a class="home-a clients" href="<?php echo e(url('/home/clients_image')); ?>">Cargar imagen de los clientes</a></li>
                            <li><a class="home-a teams" href="<?php echo e(url('/home/team_image')); ?>">Cargar imagen del team</a></li>
                        </ul>
                    </div>
