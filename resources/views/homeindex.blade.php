        ...
        <div class="content">
            ...
            <div class="section casos">
                ...
                <div class="casos">
                    @foreach($cases as $case)
                        <img class="caso" onclick="" src="{{$case->route}}" alt=" " />
                    @endforeach
                </div>
            </div>
            ...
            <div class="section trabajos">
                ...
                <div class="trabajos">
                    @foreach($portfolios as $portfolio)
                        <img class="trabajo" onclick="" src="{{$portfolio->route}}" alt=" " />
                    @endforeach
                </div>
            </div>
            ...
            <div class="section testimonios">
                <div class="slide_c">
                    <div class="slides">
                        <div class="slide n1">
                            <img class="pic" src="{{$testimonials[0]->id_images}}" alt=" " />
                            <p>{{$testimonials[0]->bio}}</p>
                            <p><span class="autor">{{$testimonials[0]->name}}</span><br>{{$testimonials[0]->author}}<br></p>
                        </div>
                        <div class="slide n2" style="display: none;">
							<img class="pic" src="{{$testimonials[1]->id_images}}" alt=" " />
							<p>{{$testimonials[1]->bio}}</p>
							<p><span class="autor">{{$testimonials[1]->name}}</span><br>{{$testimonials[1]->author}}<br></p>
						</div>
						
                        <div class="slide n3" style="display: none;">
							<img class="pic" src="{{$testimonials[2]->id_images}}" alt=" " />
							<p>{{$testimonials[2]->bio}}</p>
							<p><span class="autor">{{$testimonials[2]->name}}</span><br>{{$testimonials[2]->author}}<br></p>
						</div>
            ...
            <div class="section clientes">
                <h2>CONFÍAN EN NOSOTROS</h2>
                    <img class="logos" src="{{$clients[0]->route}}" alt="Clientes" />
                    <img class="logos2" src="{{$clients[1]->route}}" alt="Clientes" />
            </div>
